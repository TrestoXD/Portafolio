    ...
    MainmenuExe('0px','40px', true,false,`
        <div style="display:flex">
            ...
            <div style="display:flex; flex-direction:column; width:100%;">
                <button> <img src="./Styles/icons/directory_program_group.ico"> <p>Programas</p> <img class="arrow" src="./Styles/icons/Arrow.ico"> </button>
                <button> <img src="./Styles/icons/documents_normal.ico"> <p>Documentos</p> <img class="arrow" src="./Styles/icons/Arrow.ico"> </button>
