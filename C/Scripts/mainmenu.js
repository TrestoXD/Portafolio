    ...
    MainmenuExe('0px','40px', true,false,`
        <div style="display:flex">
            ...
            <div style="display:flex; flex-direction:column; width:100%;">
                ...
                <hr>
                <button onmouseenter="Delete_MainmenusecExe()" style=bottom:0;> <img src=./Styles/appicons/shutdownnormal2.png style=height: 55px; margin:-6px> <p>Apagar...</p></button>
            </div>
        </div>
        `);
}

let Programs_Menu = `<div> <button> <img src=./Styles/icons/MiniIcons/Program_group1-3.ico> Accessories</button> <button> <img src=./Styles/icons/MiniIcons/Program_group1-3.ico> Online Services</button> <button> <img src=./Styles/icons/MiniIcons/Program_group1-3.ico> StartUp</button> <button><img src=./Styles/icons/MiniIcons/msie1-3.png><p>Internet Explorer</p></button> <button onclick=CmdEXE()> <img src=./Styles/appicons/msdos1.png> CMD</button> <button>Mail</button> <button><img src=./Styles/icons/MiniIcons/WindowsExplorer.ico>Windows Explorer</button> </div>`
